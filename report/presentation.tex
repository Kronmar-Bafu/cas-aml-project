...
\begin{itemize}
  ...
  \item 2,696 plant species from GBIF, 21 environmental features
\end{itemize}
...
\begin{itemize}\setlength\itemsep{1pt}
  ...
  \item[\checkmark] 2,696 species with suitability scores
  \item[\checkmark] RF baseline for comparison (same patches, no graph)
  \item[\checkmark] Swiss Red List threat status for all species
\end{itemize}
...
\begin{itemize}\setlength\itemsep{1pt}
  ...
  \item Can we lower the 20-patch threshold for threatened species?
\end{itemize}
